...
urlpatterns = [  # pylint: disable=invalid-name
    ...
    path('contribute.json', TemplateView.as_view(template_name='contribute.json', content_type='application/json')),
    ...
    re_path(r'\.well-known/acme-challenge/(?P<challenge_key>[a-zA-Z0-9\-_]+)$', views.site.certbot),
]
...
if not ACCOUNT_REQUIRED:  # pylint: disable=invalid-name
    ...
    urlpatterns.insert(0, path(r'sitemap.xml', sitemap, {'sitemaps': sitemaps}, name='django.contrib.sitemaps.views.sitemap'))  # nopep8
