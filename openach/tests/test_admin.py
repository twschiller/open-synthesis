...
class AccountManagementTests(TestCase):
    ...
    @override_settings(INVITATIONS_INVITATION_ONLY=False, INVITE_REQUEST_URL='https://google.com')
    ...
    @override_settings(INVITATIONS_INVITATION_ONLY=True,
                       INVITE_REQUEST_URL='https://google.com')
